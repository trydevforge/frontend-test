...
import { TableUI } from "@/app/ui-components";
import NiceModal from "@ebay/nice-modal-react";
import { ColumnDef } from "@tanstack/react-table";
import { useRouter } from "next/router";
import { ActionsContainer, HeaderContainer, HeaderSubtitle, HeaderTitle } from "./styled";
...
export const ProductListingContainer: React.FC<ProductListProps> = ({
  ...
  return (
    <Box>
      <HeaderContainer>
        <HeaderTitle>Product Listing</HeaderTitle>
      </HeaderContainer>
      <TableUI
        columns={columns}
